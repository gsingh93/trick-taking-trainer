    ...
    voidOptions: [
      {
        ...
        disabled: !voidTrackingEnabled,
        className: !voidTrackingEnabled ? "opacity-50" : "",
        tooltip: "Only prompt after a lead when you are the leader of the trick",
      },
      {
        ...
        disabled: !voidTrackingEnabled || voidPromptOnlyWhenLeading,
        className: !voidTrackingEnabled || voidPromptOnlyWhenLeading ? "opacity-50" : "",
